...
from community.api.joinrequest.views import JoinRequestList, JoinRequestAccept, JoinRequestDecline, JoinCommunity
...
urlpatterns = [
    ...
    path('<slug:community_slug>/join', JoinCommunity.as_view(), name='join-community'),
